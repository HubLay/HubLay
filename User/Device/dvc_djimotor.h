...
enum Enum_DJI_Motor_Control_Method
{
    ...
    DJI_Motor_Control_Method_TORQUE,                            //扭矩控制模式
    DJI_Motor_Control_Method_OMEGA,                             //控制转速模式
    DJI_Motor_Control_Method_ANGLE,                             //控制旋转角度模式，角度环加速度环，实现角度的精确控制
    DJI_Motor_Control_Method_IMU_OMEGA,                         //IMU搭配的模式控制
...
float Class_DJI_Motor_C620::Get_Trer_Rad_Yaw()
{
    return (True_Rad_Yaw);
} 

float Class_DJI_Motor_C620::Get_True_Gyro_Yaw()
{
    return (True_Gyro_Yaw);
}

float Class_DJI_Motor_C620::Get_True_Angle_Yaw()
{
