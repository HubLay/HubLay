...
void Class_DJI_Motor_C620::TIM_PID_PeriodElapsedCallback()
{
    ...
    {
        PID_Omega.Set_Target(Target_Omega_Radian);
        PID_Omega.Set_Now(Data.Now_Omega_Radian); // 由can接收数据解析得到
        PID_Omega.TIM_Adjust_PeriodElapsedCallback();
    ...
    case (DJI_Motor_Control_Method_IMU_ANGLE):
    {
        ...
        Target_Torque = PID_Omega.Get_Out();
        Out = Target_Torque;//PID_Omega.Get_Out();
    }
	break;
...
void Class_DJI_Motor_C620::Transform_Angle()
{
