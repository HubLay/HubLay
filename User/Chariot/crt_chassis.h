...
{
    Chassis_Control_Type_DISABLE = 0,                       //底盘断连失能
    Chassis_Control_Type_FLLOW,                             //底盘随动
    Chassis_Control_Type_SPIN,                              //底盘高速旋转
};
...
public:
    ...
    void TIM_Calculate_PeriodElapsedCallback(Enum_Sprint_Status __Sprint_Status);
        ...
        inline void Set_TestSpeed(float __M1_Omega,float __M2_Omega,float __M3_Omega,float __M4_Omega);
        inline void Set_Rad(float __M1_Rad,float __M2_Rad,float __M3_Rad,float __M4_Rad);
 ...
 * @brief 设定目标速度X
 *
 * @param __Target_Velocity_X 目标速度
 */
...
void Class_Tricycle_Chassis::Set_TestSpeed(float __M1_Omega,float __M2_Omega,float __M3_Omega,float __M4_Omega){
    M1_Omega = __M1_Omega;
    M2_Omega = __M2_Omega;
    M3_Omega = __M3_Omega;
    M4_Omega = __M4_Omega;
...
void Class_Tricycle_Chassis::Set_Rad(float __M1_Rad,float __M2_Rad,float __M3_Rad,float __M4_Rad){
    M1_Rad = __M1_Rad;
    M2_Rad = __M2_Rad;
    M3_Rad = __M3_Rad;
    M4_Rad = __M4_Rad;
